...
type VerifierConfig struct {
	...
	VerifierPublicKey     string `env:"main_account_public_key" envDefault:"0xb2571928F73a6Ecd86c17b60863e6F9cF1Cf2084"`                          // public key of account who deploy plasma contract and who push blocks to it (operator)
	PlasmaContractAddress string `env:"plasma_contract_address" envDefault:"0x56f3f76dd4a96de58a2f5202b245ad6424f6ef04"`                          // address of plasma smart contract
